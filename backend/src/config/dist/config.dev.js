...
var envVarsSchema = Joi.object().keys({
  ...
  JWT_RESET_PASSWORD_EXPIRATION_MINUTES: Joi.number()["default"](30).description('minutes after which reset password token expires'),
  JWT_VERIFY_EMAIL_EXPIRATION_MINUTES: Joi.number()["default"](525960).description('minutes after which verify email token expires'),
  ...
  CORS_ORIGINS: Joi.string().description('whitelisted domains')["default"]('http://localhost:3000 https://www.sharingan.me https://sharingan-frontend.herokuapp.com')
}).unknown();
